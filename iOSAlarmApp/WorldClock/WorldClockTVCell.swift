...
class WorldClockTVCell: UITableViewCell {
    var cityNameLabel: UILabel!
    var timeOffsetLabel: UILabel!
    var currentTimeLabel: UILabel!
    var timeOfDayLabel: UILabel!
    var cityDetailsStackView: UIStackView!
    ...
    private func setupLabels() {
        ...
        timeOffsetLabel = UILabel()
        timeOffsetLabel.font = UIFont.systemFont(ofSize: 16, weight: .regular)
        timeOffsetLabel.textColor = .lightGray

        currentTimeLabel = UILabel()
        currentTimeLabel.font = UIFont.systemFont(ofSize: 40, weight: .light)
        currentTimeLabel.textColor = .white
        currentTimeLabel.textAlignment = .right

        timeOfDayLabel = UILabel()
        timeOfDayLabel.font = UIFont.systemFont(ofSize: 30, weight: .light)
        timeOfDayLabel.textColor = .white
        timeOfDayLabel.textAlignment = .right
    }
